...
.STACK 100H
.DATA
VAR DB "Enter the first character : $"
VAR2 DB "Enter the second character : $"
VAR3 DB "Your first character was : $"
VAR4 DB "Your second character was : $"
...
MAIN PROC
    ...
    MOV AH, 2    ;Output a character command
    INT 21H      
